# Reference : https://github.com/kshitizrimal/Fast-SCNN
...
def fast_scnn(output_channels:int):
  ...
  input_layer = tf.keras.layers.Input(shape=(480, 640, 3), name = 'input_layer')
  ...
  classifier = conv_block(classifier, 'conv', output_channels, (1, 1), strides=(1, 1), padding='same', relu=False) ## MOD : to have 2 classes instead of 19
